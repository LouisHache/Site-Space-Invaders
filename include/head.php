...
<html lang="fr">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-toggleable-md navbar-light navbar-custom bg-faded py-lg-4">
        ...
        <div class="container">
            <a class="navbar-brand text-uppercase text-expanded font-weight-bold hidden-lg-up" href="#">Space Invaders</a>
            <div class="collapse navbar-collapse" id="navbarExample">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-2">
                        <a class="nav-link text-uppercase text-expanded" href="developpement.php">Développement</a>
                    </li>
                
                    <li class="nav-item px-lg-2">
                        <a class="nav-link text-uppercase text-expanded" href="retour.php">Apports</a>
                    </li>
                    <li class="nav-item px-lg-2">
                        <a class="nav-link text-uppercase text-expanded" href="futur.php">L'avenir</a>
                    </li>
                </ul>
            </div>
        </div>
